...
public class TestCore
{
    ...
    public void BookingMaksRooms()
    {
        ...
        UserType student = new UserType(1, "student", false, false, false, false, 2, groupList);
        ...
        Booking booking1 = new Booking(1, bookingInterval, C0207, bob, null);
        Booking booking2 = new Booking(1, bookingInterval, C0208, bob, null);

        assertThrows(IndexOutOfBoundsException.class, () -> new Booking(1, bookingInterval, C0209a, bob, null));
    }
 ...
 /*
    ...
    public void ConstructorOfUserType()
    {
        ...
        UserType student = new UserType(1, "student", false, false, false, false, 2, userBob);

        assertEquals(student, new UserType(1, "student", false, false, false, false, 2, userBob));
        assertNotEquals(student, new UserType(2, "student", false, false, false, false, 2, userBob));
    }
    //TODO Test unik id og ingen duplicate
