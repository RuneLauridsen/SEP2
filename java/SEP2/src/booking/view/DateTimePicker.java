...
// NOTE(rune): https://stackoverflow.com/a/35639169
...
public class DateTimePicker extends DatePicker
{
    ...
    public DateTimePicker()
    {
        ...
        accessibleTextProperty().addListener((observable, oldValue, newValue) -> {
            if (newValue == null)
            {
            ...
            else
            {
                ...
                {
                    dateTimeValue.set(LocalDateTime.of(getValue(), LocalTime.now()));
                }
                else
                {
                    LocalTime time = dateTimeValue.get().toLocalTime();
                    dateTimeValue.set(LocalDateTime.of(getValue(), time));
                }
            }
        });
